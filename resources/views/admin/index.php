                     ...
                     <div class="row g-0">
                        ...
                        <div class="col-lg-6">
                           <div class="card-body p-4 p-sm-5">
                              <h5 class="login-title text-center">Welcome!</h5>
                              <h5 class="card-title text-center">Rental Management System</h5>
                              <form class="form-body">
                                 ...
                                 <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                       <div class="d-grid">
                                          <a href="dashboard.php" class="btn btn-primary radius-30">Sign In</a>
                                       </div>
                                    </div>
                                    <!--<div class="col-12">-->
