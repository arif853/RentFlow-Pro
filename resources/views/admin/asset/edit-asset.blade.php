                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <label class="form-label">Unit Name<span
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Asset Code"
                                                name="asset_code" id="" readonly required
                                                value="{{$asset->asset_code}}">
                                        </div>
                                        <!--Row-5-->
                                        <div class="col-12">
                                            <label class="form-label">Building<span class="text-danger">*</span></label>
                                            <select class="form-select" name="building_id" id="building-select"
                                                required>
                                                <option value="">Select Building</option>
                                                @foreach ($buildings as $building)
                                                <option value="{{ $building->id }}"
                                                    {{$asset->building_id == $building->id ? 'selected' : '' }}>
                                                ...
                                                <div class="card-body">
                                                    <ul class="list-group list-group-flush">
                                                        <li
                                                            ...
                                                            <span
                                                                id="building-name">{{$asset->building->building_name}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Building Type :</span>
                                                            <span
                                                                id="building-type">{{$asset->building->building_type}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Total Floor :</span>
                                                            <span
                                                                id="total-floor">{{$asset->building->total_floor}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Building Code :</span>
                                                            <span
                                                                id="building-code">{{$asset->building->building_code}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Address :</span>
                                                            <span
                                                                id="building-address">{{$asset->building->address}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Security Guard Name :</span>
                                                            <span
                                                                id="guard-name">{{$asset->building->security_guard_name}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Guard Contact Number :</span>
                                                            <span
                                                                id="guard-contact">{{$asset->building->guard_contact_number}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Gate Open Time :</span>
                                                            <span
                                                                id="gate-open-time">{{$asset->building->gate_open_time}}</span>
                                                        </li>
                                                        <li
                                                            class="list-group-item d-flex justify-content-between align-items-center bg-transparent">
                                                            <span class="side-title">Gate Close Time :</span>
                                                            <span
                                                                id="gate-close-time">{{$asset->building->gate_close_time}}</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Floor Size" readonly
                                                id="floorSize" value="{{$asset->floor->floor_size}}">
                                        </div>
                                        <div class="col-12 col-md-4">
                                            <label class="form-label">Total Unit</label>
                                            <input type="text" class="form-control" placeholder="Total Unit" readonly
                                                id="floorUnit" value=" {{$asset->floor->total_unit}}">
                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="gas_type" id="gasType">
                                                                ...
                                                                <option value="Prepaid"
                                                                    {{$asset->gas_type =='Prepaid' ? 'selected' : '' }}>
                                                                    Prepaid</option>
                                                                <option value="Post Paid"
                                                                    {{$asset->gas_type =='Post Paid' ? 'selected' : '' }}>
                                                                    Post Paid</option>
                                                                <option value="Partial"
                                                                    {{$asset->gas_type =='Partial' ? 'selected' : '' }}>
                                                                    Partial</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row g-3" id="gasAmountCard"
                                                        style="{{$asset->gas_type == 'Partial' ? '' : 'display: none' }}">
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Owner Part amount</label>
                                                            <input type="number" class="form-control"
                                                                placeholder="Owner Part amount"
                                                                name="gas_owner_part_amount"
                                                                value="{{$asset->gas_owner_part_amount}}">
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Rental Part amount </label>
                                                            <input type="number" class="form-control"
                                                                placeholder="Rental Part amount "
                                                                name="gas_rental_part_amount"
                                                                value="{{$asset->gas_rental_part_amount}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="lift_facility">
                                                                ...
                                                                <option value="Yes"
                                                                    {{$asset->lift_facility == 'Yes' ? 'selected' : ''}}>
                                                                    Yes</option>
                                                                <option value="No"
                                                                    {{$asset->lift_facility == 'No' ? 'selected' : ''}}>
                                                                    No</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="row g-3 mb-2">
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="electricity_type"
                                                                id="electricityType">
                                                                <option value="Prepaid"
                                                                    {{$asset->electricity_type == 'Prepaid' ? 'selected' : ''}}>
                                                                    Prepaid</option>
                                                                <option value="Post Paid"
                                                                    {{$asset->electricity_type == 'Post Paid' ? 'selected' : ''}}>
                                                                    Post Paid</option>
                                                                <option value="Partial"
                                                                    {{$asset->electricity_type == 'Partial' ? 'selected' : ''}}>
                                                                    Partial</option>
                                                            </select>
                                                        </div>

                                                    </div>
                                                    <div class="row g-3" id="ElectricityAmountCard"
                                                        style="{{$asset->electricity_type == 'Partial' ? '' : 'display: none'}}">
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Owner Part amount</label>
                                                            <input type="number" class="form-control"
                                                                placeholder="Owner Part amount"
                                                                name="e_owner_part_amount"
                                                                value="{{$asset->e_owner_part_amount}}">
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Rental Part amount </label>
                                                            <input type="number" class="form-control"
                                                                placeholder="Rental Part amount "
                                                                name="e_rental_part_amount"
                                                                value="{{$asset->e_rental_part_amount}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row g-3 mb-2">
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-select" name="water_type"
                                                                id="waterType">
                                                                <option value="Prepaid"
                                                                    {{$asset->water_type == 'Prepaid' ? 'selected' : ''}}>
                                                                    Prepaid</option>
                                                                <option value="Post Paid"
                                                                    {{$asset->water_type == 'Post Paid' ? 'selected' : ''}}>
                                                                    Post Paid</option>
                                                                <option value="Partial"
                                                                    {{$asset->water_type == 'Partial' ? 'selected' : ''}}>
                                                                    Partial</option>
                                                            </select>
                                                        </div>

                                                    </div>
                                                    <div class="row g-3" id="waterAmountCard"
                                                        style="{{$asset->water_type == 'Partial' ? '' : 'display: none'}}">
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Owner Part amount</label>
                                                            <input type="number" class="form-control"
                                                                placeholder="Owner Part amount"
                                                                name="water_owner_part_amount"
                                                                value="{{$asset->water_owner_part_amount}}">
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Rental Part amount </label>
                                                            <input type="number" class="form-control"
                                                                placeholder="Rental Part amount "
                                                                name="water_rental_part_amount"
                                                                value="{{$asset->water_rental_part_amount}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3 mb-2">
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Guard Bill"
                                                        name="guard_amount" value="{{$asset->guard_amount}}">
                                                </div>
                                                <div class="col-12 col-md-4">
                                                    <label class="form-label">Internet Bill</label>
                                                    <input type="number" class="form-control"
                                                        placeholder="Internet Bill" name="internet_amount"
                                                        value="{{$asset->internet_amount}}">
                                                </div>
                                                <div class="col-12 col-md-4">
                                                    <label class="form-label">Dish Bill</label>
                                                    <input type="number" class="form-control" placeholder="Dish Bill"
                                                        name="dish_amount" value="{{$asset->dish_amount}}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card shadow-none border room-card">
                                                <div
                                                    ...
                                                    <a href="{{route('asset.room.delete', $room->id)}}"
                                                        class="btn btn-danger btn-sm delete-room">Remove</a>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <input type="hidden" name="room_id[{{$key}}]"
                                                                value="{{$room->id}}">
                                                            <label class="form-label">Room Type</label>
                                                            <input type="hidden" name="room_type_id[{{$key}}]"
                                                                value="{{$room->room_type_id}}">
                                                            <select class="form-select room-type-dropdown" disabled>
                                                                {{-- @foreach ($roomtypes as $data) --}}
                                                                <option value="{{$room->room_type_id}}">
                                                                    {{$room->roomtype->roomType}}</option>
                                                                {{-- @endforeach --}}
                                                            </select>
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            ...
                                                            <input type="number" class="form-control"
                                                                placeholder="Room Size" name="room_size[{{$key}}]"
                                                                value="{{$room->room_size}}">
                                                        </div>
                                                        <div class="col-12 col-md-6">
                                                            <label class="form-label">Room Picture</label>
                                                            <input type="file" class="form-control"
                                                                placeholder="Room Picture" name="room_image[{{$key}}]">
                                                            <div class="mt-3 mb-2">
                                                                <img src="{{asset('storage/room_images/'.$room->room_image)}}"
                                                                    alt="No image found." width="200" height="100">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12 col-md-4">
                                                            <ul class="list-group list-group-flush">
                                                                <li
                                                                    ...
                                                                    <span class="side-title">Electricity Power
                                                                        Enable?</span>
                                                                    <span>
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <span>
                                                                                <div class="form-check form-switch">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        {{$room->aircondition == 1 ? 'checked' : ''}}
                                                                                        id="flexSwitchCheckDefault"
                                                                                        name="aircondition[{{$key}}]"
                                                                                        value="{{$room->aircondition}}">
                                                                                </div>
                                                                            </span>
                                                                        </li>
                                                                    </ul>
                                                                            ...
                                                                            <span>
                                                                                <div class="form-check form-switch">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        id="flexSwitchCheckDefault"
                                                                                        name="attach_toilet[{{$key}}]"
                                                                                        {{$room->attach_toilet == 1 ? 'checked' : ''}}
                                                                                        value="{{$room->attach_toilet}}">
                                                                                </div>
                                                                            </span>
                                                                        </li>
                                                                    </ul>
                                                                        ...
                                                                        <li
                                                                            ...
                                                                            <span>
                                                                                <div class="form-check form-switch">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        value="{{$room->attach_baranda}}"
                                                                                        id="flexSwitchCheckDefault"
                                                                                        name="attach_baranda[{{$key}}]"
                                            ...
                                            <button type="button" class="btn btn-primary" id="add-room-btn">+ New
                                                Room</button>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="card shadow-none bg-light border">
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            <label class="form-label">Area/Location<span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <div class="card border shadow-none radius-10" id="location-details-card"
                                                style="margin-bottom: 0px; {{$asset->location_id ? '':'display: none;'}}">
                                                <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" name="unit_view">
                                                <option value="Front Side"
                                                    {{$asset->unit_view == 'Front Side'? 'selected':'' }}>Front Side
                                                </option>
                                                <option value="Back Side"
                                                    {{$asset->unit_view == 'Back Side'? 'selected':'' }}>Back Side
                                                </option>
                                                <option value="North View"
                                                    {{$asset->unit_view == 'North View'? 'selected':'' }}>North View
                                                </option>
                                                <option value="South View"
                                                    {{$asset->unit_view == 'South View'? 'selected':'' }}>South View
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Monthly Rent</label>
                                            <input type="number" class="form-control" placeholder="Monthly Rent "
                                                name="monthly_rent" value="{{$asset->monthly_rent}}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Service Charge </label>
                                            <input type="number" class="form-control" placeholder="Service Charge "
                                                name="service_charge" value="{{$asset->service_charge}}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Others Charge </label>
                                            <input type="number" class="form-control" placeholder="Others Charge "
                                                name="others_charge" value="{{$asset->others_charge}}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Available From</label>
                                            <input type="date" class="form-control" placeholder="Available From"
                                                name="available_from" value="{{$asset->available_from}}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">Others Description </label>
                                            <textarea class="form-control" placeholder="Others Description "
                                                name="others_description" rows="4"
                                                cols="4">{{$asset->others_description}}</textarea>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="card border shadow-none radius-10" id="employee-details-card"
                                                style="margin-bottom: 0px; {{$asset->employee_id ? '' : 'display: none;'}} ">
                                                <div class="card-body">
                                                    <div class="align-items-center">
                                                        <div class="">
                                                            <ul class="list-group list-group-flush">
                                                                <li
                                                                    ...
                                                                    <span
                                                                        id="employee-name">{{$asset->employee ? $asset->employee->name : ''}}</span>
                                                                </li>
                                                                <li
                                                                    class="d-flex justify-content-between align-items-center bg-transparent mb-2">
                                                                    <span class="side-title">Designation:</span>
                                                                    <span
                                                                        id="employee-designation">{{$asset->employee ? $asset->employee->designation->designation_name :''}}</span>
                                                                </li>
                                                                <li
                                                                    class="d-flex justify-content-between align-items-center bg-transparent mb-2">
                                                                    <span class="side-title">ID:</span>
                                                                    <span
                                                                        id="employee-id">{{$asset->employee ? $asset->employee->employee_code :''}}</span>
                                                                </li>
                                                                <li
                                                                    class="d-flex justify-content-between align-items-center bg-transparent mb-2">
                                                                    <span class="side-title">Phone:</span>
                                                                    <span
                                                                        id="employee-phone">{{$asset->employee ? $asset->employee->phone :''}}</span>
                                                                </li>
                                                                <li
                                                                    class="d-flex justify-content-between align-items-center bg-transparent mb-2">
                                                                    <span class="side-title">Date of Joining:</span>
                                                                    <span
                                                                        id="employee-joining-date">{{\Carbon\Carbon::parse($asset->employee ? $asset->employee->date_of_joining : '')->format(' d-M-Y')}}</span>
                                                                </li>
                                                                <li
                                                                    class="d-flex justify-content-between align-items-center bg-transparent mb-2">
                                                                    <span class="side-title">NID Number:</span>
                                                                    <span
                                                                        id="employee-nid">{{$asset->employee ? $asset->employee->nid_number :''}}</span>
                                                                </li>
                                                                <li
                                                                    class="d-flex justify-content-between align-items-center bg-transparent mb-2">
                                                                    <span class="side-title">Present Address:</span>
                                                                    <span
                                                                        id="employee-address">{{$asset->employee ? $asset->employee->present_address :''}}</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" name="status">
                                                <option value="1" {{$asset->status == '1' ? 'selected':''}}>Active
                                                </option>
                                                <option value="0" {{$asset->status == '0' ? 'selected':''}}>Inactive
                                                </option>
                                            </select>
                                        </div>
                                    </div>
    ...
    $(document).ready(function () {
        ...
        $('#building-select').on('change', function () {
            ...
            if (buildingId) {
                ...
                $.ajax({
                    url: '/dashboard/building/building_details/' +
                    buildingId, // Update with your actual URL endpoint
                    method: 'GET',
        ...
        $('#employee-select').on('change', function () {
            ...
            if (employeeId) {
                ...
                $.ajax({
                    url: '/dashboard/building/employee_details/' +
                    employeeId, // Update with your actual URL endpoint
                    method: 'GET',
                    success: function (data) {
        ...
        $('#location-select').on('change', function () {
            ...
            if (locationId) {
                ...
                $.ajax({
                    url: '/dashboard/locations/location-list/' +
                    locationId, // Update with your actual URL endpoint
                    method: 'GET',
                    success: function (data) {
        ...
        $('#add-room-btn').on('click', function () {
            ...
            $.each(roomTypes, function (index, type) {
                roomTypeDropdown.append('<option value="' + type.id + '">' + type.roomType +
                    '</option>');
            });
