...
<main class="page-content">
    ...
    <div class="row">
        <div class="col-md-6 ">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('websetting.update', $company->id) }}" method="POST" enctype="multipart/form-data" class="">
                        @csrf
                        @method('PUT')
                        <div class="col-12">
                            <!-- Company Name -->
                            ...
                            <div class="mb-3 text-center">
                                <img id="logo-preview" src="{{ asset('storage/' . $company->logo) }}" alt="Logo Preview"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mx-auto d-flex justify-content-center">
                        <div class="text-center mb-4 w-100" style="">
                            ...
                            <!-- Phone Number -->
                            <p class="mb-1" style=""><strong>Phone:</strong> {{ $company->phone_number }}
                            </p>

                            <!-- Email -->
                            <p class="mb-1" style=""><strong>Email:</strong> {{ $company->email }}</p>

                            <!-- Address -->
                            <p class="mb-1" style=""><strong>Address:</strong> {{ $company->address }}
                            </p>
                        </div>
                    </div>
                </div>
